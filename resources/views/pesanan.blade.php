...
<div>
    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      ...
      <li>
        <a href="#" class="nav-link active py-3 border-bottom rounded-0 sideActive" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Pesanan" data-bs-original-title="Pesanan">
        ...
        <div class="pesanan" id="pesanan">
           <div class="card" style="margin-left:20px;">
                  <div class="card-header">
                      <span class="h5 my-2"><i class="fa-solid fa-list"></i> Daftar Penyewa Mobil</span>
                  </div>
                  <div class="card-body">
                      <table class="table table hover" id="datatablesSimple">
                          <thead>
                              <tr>
                                  ...
                                  <th scope="col"><center>Mobil</center></th>
                                  <th scope="col"><center>Alamat</center></th>
                                  <th scope="col"><center>Status Pembayaran</center></th> 
                          ...
                          <tbody>
                              <tr>
                                  ...
                                  <td align="center">
                                      <a class="btn btn-sm btn-danger" title="Hapus Siswa" onclick="return confirm('Anda yakin ingin menghapus data ini ?')"><i class="fa-solid fa-trash"></i></a>
                                  </td>
                              </tr>
                              <tr>
                                  <th scope="row">2</th>
                                  <td align="center">Anto</td>
                                  <td align="center">Mobilio</td>
                                  <td align="center">Bandung</td>

            ...
            <div class="container my-5">
                ...
                <form>
                    <div class="form-group row mb-3 mt-3">
                        ...
                        <div class="col-sm-9">
                        <input type="text" class="form-control" id="nama" placeholder="Avanza">
                        </div>
                    </div>

                    <div class="form-group row mb-3 mt-3">
                        <label for="sewa" class="col-sm-3 col-form-label">Sewa Per Hari</label>
                        <div class="col-sm-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                            <span class="input-group-text">Rp</span>
                            </div>
                            <input type="text" class="form-control" id="sewa" placeholder="0,-" value="0">
                    ...
                    <div class="form-group row mb-3 mt-3">
                        ...
                        <div class="input-group">
                            <!-- <div class="input-group-prepend">
                            <span class="input-group-text">https://placeimg.com/640/480/any</span>
                            </div> -->
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="foto">
                                <br>
                                <label class="custom-file-label" for="foto" style="font-size:13px; color:grey;">File size max 2MB</label>
                            </div>
                        </div>
                        </div>
                    </div>
                ...
                <div class="d-flex mb-4 mt-10">
                    <button class="btn btn-filter mr-auto" style="border:1px solid blue;"><a href="{{route('mobil')}}" style="color:black; text-decoration: none;">Cancel</a></button>
                    <button class="btn btn-primary btn-new-card">Save</button>
            </div>
        </div>

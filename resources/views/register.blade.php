                ...
                <form action="/register" method="POST" style="width: 60%;" id="registerForm">
                    ...
                    <div class="form-row my-4">
                        <div class="input-group">
                            <div class="form-floating">
                                <input name="password" type="password" value="" class="input form-control @error('password') is-invalid @enderror" id="inputPassword" aria-label="password" aria-describedby="basic-addon1" placeholder="password" required />
                    ...
                    <div class="form-row my-4">
                        <div class="input-group">
                            <div class="form-floating">
                                <input name="password_confirmation" type="password" value="" class="input form-control @error('password') is-invalid @enderror" id="inputKonfirmasiPassword" aria-label="password" aria-describedby="basic-addon1" placeholder="confirm password" required />
